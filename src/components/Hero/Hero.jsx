...
const codeLines = [
  ...
  { text: '  name: "Nishat",',     color: "text-green-400" },
  { text: '  role: "FullStack",',  color: "text-blue-400" },
  { text: '  stack: ["MERN"],',    color: "text-yellow-400" },
  { text: '  loves: "UI/UX",',     color: "text-pink-400" },
  { text: "  available: true,",    color: "text-emerald-400" },
  { text: "};",                    color: "text-purple-400" },
  { text: "",                      color: "" },
  { text: "dev.buildSomething()",  color: "text-cyan-400" },
  { text: "// 🚀 Let's go!",       color: "text-gray-500" },
];
